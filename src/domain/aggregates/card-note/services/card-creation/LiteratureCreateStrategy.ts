...
export class LiteratureCreateStrategy implements CardGenerationStrategy {
  ...
  constructor(
    ...
    this.delegate = new GenericCreateStrategy(
      ...
      cardMetaProcessor,
      clock,
      CardScene.LITERATURE,
      { prefix: "📖literature_", templateKey: "literature" }
    );
  }
  getCardScene(): CardScene { return CardScene.LITERATURE; }
